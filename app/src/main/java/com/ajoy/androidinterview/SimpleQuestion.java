...
public class SimpleQuestion extends AppCompatActivity implements View.OnClickListener {
    ...
    Button buttonLeft, buttonAns, buttonRight, bspeak, bmute;
    LinearLayout layout;
    int index;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_questions.setText(simple_questions[index]);
        ...
        questionstype.setText("Simple Questions");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            ...
            case R.id.bshowans:
                tv_answers.setText(simple_answers[index]);
